        ...
        try:
            ...
            if (predictions and
                ...
                if state["current_confidence"] > 0.80:
                    ...
                    result_text = most_common

                    result_tts = convert_to_egyptian_pronunciation(
                    result_text
                    )

                    print(f"⚡ INSTANT: {result_text}")

                    result_audio = generate_tts_audio(
                        result_tts,
                        tts_voice,
                        tts_rate,
                        tts_volume,
